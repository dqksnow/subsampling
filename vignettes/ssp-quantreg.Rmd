...
This vignette shows how to use `ssp.quantreg`. The statistical theory and
algorithms behind this implementation can be found in the relevant reference
papers.
...
After drawing subsample(s), `ssp.quantreg` uses `quantreg::rq` to fit the
