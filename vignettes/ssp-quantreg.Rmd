...
This vignette introduces the usage of `ssp.quantreg`. It provides a subsampling
method for quantile regression model on massive datasets. The statistical theory
...
data size is $N = 1 \times 10^4$. The interested quantile is 0.75.
...
by minimizing a transformation of the asymptotic covariance of subsample
...
An option for drawing $B$ subsamples (each with size `n.ssp`) and deriving
